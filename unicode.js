...
let firstUniCode = inputString2.charCodeAt(0);
let lastUniCode = inputString2.charCodeAt(inputString2.length - 1);
let swappedString =
  String.fromCharCode(lastUniCode) +
  inputString2.slice(1, -1) +
  String.fromCharCode(firstUniCode);
